---
name: bootstrap-evidence-app
description: Implement an evidence-backed application from one product prompt with authorized context reuse, data curation, tracing, calibrated evaluation, UI proof and governed harness improvement.
---
